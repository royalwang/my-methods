                    ...
                    if (e.canBack) {
                        ...
                        if (wobj.id === plus.runtime.appid) {
                            ...
                            if (!$.__back__first) {
                                ...
                                if (new Date().getTime() - $.__back__first < 2e3) {
                                    plus.runtime.quit();
                                }
                            }
                        } else {
                ...
                case "dragend":
                    if (this.isDragging) {
                        ...
                        if (!this.slideIn) {
                            ...
                            if (direction === "right" && ratio >= 0 && (ratio >= .5 || detail.swipe)) {
                                //右滑打开
                                this.openPercentage(100);
                            } else if (direction === "right" && ratio < 0 && (ratio > -.5 || detail.swipe)) {
                                //右滑关闭
                                this.openPercentage(0);
                            } else if (direction === "right" && ratio > 0 && ratio < .5) {
                                //右滑还原关闭
                                this.openPercentage(0);
                            } else if (direction === "right" && ratio < .5) {
                                //右滑还原打开
                                this.openPercentage(-100);
                            } else if (direction === "left" && ratio <= 0 && (ratio <= -.5 || detail.swipe)) {
                                //左滑打开
                                this.openPercentage(-100);
                            } else if (direction === "left" && ratio > 0 && (ratio <= .5 || detail.swipe)) {
                                //左滑关闭
                                this.openPercentage(0);
                            } else if (direction === "left" && ratio < 0 && ratio >= -.5) {
                                //左滑还原关闭
                                this.openPercentage(0);
                            } else if (direction === "left" && ratio > .5) {
                                //左滑还原打开
                                this.openPercentage(100);
                            } else {
                                //默认关闭
                            ...
                            if (direction === "right" && ratio <= 0 && (ratio >= -.5 || detail.swipe)) {
                                ...
                                //左滑还原关闭
                                this.openPercentage(0);
                            } else if (direction === "left" && ratio >= -.5 && ratio < 0) {
                                //左滑还原打开
                                this.openPercentage(100);
                            } else {
                                this.openPercentage(0);
