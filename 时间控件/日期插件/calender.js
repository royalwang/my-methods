window.calender = (function(win, doc) {
    ...
    C.prototype = {
        ...
        create: function() {
            ...
            if (this.s.button) {
                html += '<div class="calender-button"><a href="javascript:;" class="calender-ent">确定</a><a href="javascript:;" class="calender-today">今天</a><a href="javascript:;" class="calender-clear">清除</a></div>';
            };
    ...
    function c(o, b) { return new C(o, b) };
    return c;
})(window, document);